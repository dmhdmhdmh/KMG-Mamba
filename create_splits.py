...
parser.add_argument('--task', type=str, default='task_subtyping_nsclc')
...
if args.task == 'task_1_tumor_vs_normal':
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/CAMELYON_label.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
    ...
    args.n_classes=3
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/label.csv',
                                                 shuffle = False,
                                                 seed = args.seed,
                                                 print_info = True,
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/NSCLC_label.csv',
                                                 shuffle = False,
                                                 seed = args.seed,
                                                 print_info = True,
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/BRCA_label.csv',
                                                 shuffle = False,
                                                 seed = args.seed,
                                                 print_info = True,
